...
public class TS3GetBeginJava
{
  ...
  protected final String TEXT_124 = ".setUserAgent(routines.system.Constant.TALEND_USER_AGENT);" + NL + "\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\t\tint scketSendBufferSizeHints_";
  protected final String TEXT_126 = " = 0;" + NL + "\t\t\t\t\tint socketReceiveBufferSizeHints_";
  protected final String TEXT_127 = " = 0;" + NL + "\t\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\t\tscketSendBufferSizeHints_";
  protected final String TEXT_129 = " = ";
  protected final String TEXT_130 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\t\tsocketReceiveBufferSizeHints_";
  protected final String TEXT_132 = " = ";
  protected final String TEXT_133 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\t\t\tcc_";
  protected final String TEXT_135 = ".setProtocol(com.amazonaws.Protocol.";
  protected final String TEXT_136 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_137 = NL + "\t\t\t\t\tcc_";
  protected final String TEXT_138 = ".set";
  protected final String TEXT_139 = "(";
  protected final String TEXT_140 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\tcc_";
  protected final String TEXT_142 = ".setSocketBufferSizeHints(scketSendBufferSizeHints_";
  protected final String TEXT_143 = ",socketReceiveBufferSizeHints_";
  protected final String TEXT_144 = ");" + NL + "\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\tint sessionDurationSeconds_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = " * 60;" + NL + "\t\t\tcom.amazonaws.auth.STSAssumeRoleSessionCredentialsProvider.Builder stsBuilder_";
  protected final String TEXT_148 = " = " + NL + "\t\t\t\t\tnew com.amazonaws.auth.STSAssumeRoleSessionCredentialsProvider.Builder(";
  protected final String TEXT_149 = ", ";
  protected final String TEXT_150 = ").withLongLivedCredentialsProvider(credentialsProvider_";
  protected final String TEXT_151 = ")" + NL + "\t\t\t\t\t.withRoleSessionDurationSeconds(sessionDurationSeconds_";
  protected final String TEXT_152 = ");" + NL + "\t\t\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\tstsBuilder_";
  protected final String TEXT_154 = ".withServiceEndpoint(";
  protected final String TEXT_155 = ");" + NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\tstsBuilder_";
  protected final String TEXT_157 = ".withClientConfiguration(cc_";
  ...
  protected final String TEXT_180 = " - Getting an object with key:\" + ";
  protected final String TEXT_181 = ");" + NL + "\t\t";
  protected final String TEXT_182 = NL + "\t\tconn_";
  protected final String TEXT_183 = ".getObject(new com.amazonaws.services.s3.model.GetObjectRequest(";
  protected final String TEXT_184 = ", ";
  protected final String TEXT_185 = "),new java.io.File(";
  protected final String TEXT_186 = "));" + NL + "\t\t";
  protected final String TEXT_187 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_188 = " - Get the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_189 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_190 = "){" + NL + "\t\t";
  protected final String TEXT_191 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_192 = ");" + NL + "\t\t";
  protected final String TEXT_193 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_194 = " - \" + e_";
  protected final String TEXT_195 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_196 = NL + "\t\tSystem.err.println(e_";
  protected final String TEXT_197 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_198 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_199 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_200 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
